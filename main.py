...
def root():
    ...
    return render_template(
        'index.html', user_data=claims, error_message=error_message, id_token=id_token, movies=movies)
...
def login():
    ...
    return render_template(
        'login.html', user_data=claims, error_message=error_message, id_token=id_token)
...
def pastmovies():
    ...
    return render_template(
        'pastmovies.html', user_data=claims, error_message=error_message, id_token=id_token, movies=movies)
...
def suggestamovie():
    ...
    return render_template(
        'suggestamovie.html', user_data=claims, error_message=error_message, id_token=id_token)
